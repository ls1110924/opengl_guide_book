package com.yunxian.android.opengl.chapter14.example05;
 ...
 */
public class Example05ParticleActivator extends BundleActivator {

    @Override
    protected String bundleFileName() {
        return "bundle_chapter14_example05_config.json";
    }
