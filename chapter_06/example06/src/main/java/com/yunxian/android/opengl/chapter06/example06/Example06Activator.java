package com.yunxian.android.opengl.chapter06.example06;
 ...
 */
public class Example06Activator extends BundleActivator {

    @Override
    protected String bundleFileName() {
        return "bundle_chapter06_example06_config.json";
    }
